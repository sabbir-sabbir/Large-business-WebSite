      ...
      <div className="flex items-center justify-between ml-12">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-0 w-full p-12">
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-2xl font-semibold text-[#25395c] lg:ms-14 lg:text-2xl text-center lg:text-start">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-2 mt-5">
            <h2 className="text-xl lg:text-2xl font-bold lg:w-[70%] leading-tight text-[#26395C]">
